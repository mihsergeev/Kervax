...
Мониторинг корпоративного уровня, который работает из коробки — open source, на
своих серверах, без экспортеров, которые надо связывать, и дашбордов, которые
надо собирать.

Одна панель на всю картину: и сайты, которые видят пользователи, и серверы за
ними. Kervax проверяет сайты снаружи — статус, ключевое слово, время ответа,
сроки TLS и домена, с самой панели и из других регионов — и следит за машинами
изнутри через маленький агент, который ходит **наружу**, к панели. Внутрь ваших
серверов никто не лезет, а от токена агента панель хранит только хеш.

[English version](README.md) · [Инструкция по установке](docs/install.ru.md) · [Зачем ещё одна панель](docs/why.ru.md) · [Changelog](CHANGELOG.md)
