...
const EN: Record<string, string> = {
  ...
  // --- бэкап ---
  'Бэкап': 'Backup',
  'Бэкап содержит мониторы, серверы, локации и настройки — без метрик (тайм-серий).':
    'A backup contains monitors, servers, locations and settings — without metrics (time-series).',
  ...
  'Восстановить из «{name}»? Текущие мониторы, серверы и настройки будут заменены.':
    'Restore from “{name}”? Current monitors, servers and settings will be replaced.',
