...
import { ApiError, MIN_PASSWORD_LEN, changePassword } from './api'
      ...
      <div className="card modal" onClick={(e) => e.stopPropagation()}>
        ...
        {done ? (
          ...
          <>
            ...
            <label className="field">
              <span>{t('Новый пароль (мин. {n} символов)', { n: MIN_PASSWORD_LEN })}</span>
              <input
                type="password"
                value={next}
            ...
            {tooShort && (
              <p className="form-error">{t('Пароль должен быть не короче {n} символов', { n: MIN_PASSWORD_LEN })}</p>
            )}
